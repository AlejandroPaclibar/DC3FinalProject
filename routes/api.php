...
Route::post('/purchased_items', [PurchaseItemController::class, 'store']);
Route::get('/purchased_items', [PurchaseItemController::class, 'index']);
Route::get('/purchased_items/{purchased_item}', [PurchaseItemController::class, 'view']);
Route::patch('/purchased_items/{purchased_item}', [PurchaseItemController::class, 'update']);
Route::delete('/purchased_items/{purchased_item}',[PurchaseItemController::class, 'destroy']);
